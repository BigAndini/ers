    ...
    public function getServiceConfig() {
        return array(
            'factories' => array(
                 ...
                 * MySQL Factories
                 */
                'Order\Model\StickyNotesTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\StickyNotesTable($dbAdapter);
                    return $table;
                },
                'Order\Model\UserTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\UserTable($dbAdapter);
                    return $table;
                },
                'Order\Model\RoleTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                ...
                'Order\Model\ProductVariantTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\ProductVariantTable($dbAdapter);
                    return $table;
                },
                'Order\Model\ProductVariantValueTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                 ...
                 * Form Factories
                 */
                'Order\Form\ProductViewForm' => function($sm){
