...
class Code
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Item", mappedBy="code", cascade={"persist", "merge"})
     * @ORM\JoinColumn(name="id", referencedColumnName="code_id")
     */
    protected $items;

    /**
     * @ORM\OneToMany(targetEntity="Order", mappedBy="code", cascade={"persist", "merge"})
     * @ORM\JoinColumn(name="id", referencedColumnName="code_id")
     */
    protected $orders;

    /**
     * @ORM\OneToMany(targetEntity="Package", mappedBy="code", cascade={"persist", "merge"})
     * @ORM\JoinColumn(name="id", referencedColumnName="code_id")
     */
    protected $packages;
