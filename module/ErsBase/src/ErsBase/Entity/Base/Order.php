...
abstract class Order
{
    ...
    /**
     * @ORM\Column(name="`invoice_detail`", type="string", length=1500, nullable=true)
     */
    ...
    /**
     * @ORM\Column(name="`payment_reminder_status`", type="integer", nullable=true)
     */
    protected $payment_reminder_status;

    /**
     * @ORM\Column(name="`order_sum`", type="float", nullable=true)
     */
    protected $order_sum;
    ...
    {
        $dataFields = array('id', 'code_id', 'status_id', 'buyer_id', 'payment_type_id', 'hashkey', 'invoice_detail', 'payment_status', 'payment_reminder_status', 'order_sum', 'total_sum', 'refund_sum', 'currency', 'updated', 'created');
    ...
    {
        return array('id', 'code_id', 'status_id', 'buyer_id', 'payment_type_id', 'hashkey', 'invoice_detail', 'payment_status', 'payment_reminder_status', 'order_sum', 'total_sum', 'refund_sum', 'currency', 'updated', 'created');
    }
}