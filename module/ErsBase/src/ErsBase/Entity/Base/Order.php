...
class Order
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="OrderStatus", mappedBy="order", cascade={"persist", "merge"})
     * @ORM\JoinColumn(name="id", referencedColumnName="order_id")
     */
    ...
    /**
     * Add OrderStatus entity to collection (one to many).
     *
     * @param \ErsBase\Entity\Base\OrderStatus $orderStatus
     * @return \ErsBase\Entity\Base\Order
     */
    ...
    {
        $dataFields = array('id', 'code_id', 'buyer_id', 'payment_type_id', 'hashkey', 'invoiceDetail', 'payment_status', 'order_sum', 'total_sum', 'refund_sum', 'updated', 'created');
    ...
    {
        return array('id', 'code_id', 'buyer_id', 'payment_type_id', 'hashkey', 'invoiceDetail', 'payment_status', 'order_sum', 'total_sum', 'refund_sum', 'updated', 'created');
    }
}