 ...
 * @ORM\Table(name="`payment_type`", indexes={@ORM\Index(name="fk_PaymentType_Deadline1_idx", columns={"`active_from_id`"}), @ORM\Index(name="fk_PaymentType_Deadline2_idx", columns={"`active_until_id`"}), @ORM\Index(name="fk_payment_type_currency1_idx", columns={"`currency_id`"})})
...
abstract class PaymentType
{
    ...
    /**
     * @ORM\Column(name="`preselected`", type="boolean", nullable=true)
     */
    ...
    /**
     * @ORM\Column(name="`statement_format`", type="text", nullable=true)
     */
    ...
    /**
     * @ORM\Column(name="`short_description`", type="string", length=127, nullable=true)
     */
    ...
    /**
     * @ORM\Column(name="`explanation`", type="string", length=3000, nullable=true)
     */
    protected $explanation;

    /**
     * @ORM\Column(name="`fix_fee`", type="float", nullable=true)
     */
    protected $fix_fee;

    /**
     * @ORM\Column(name="`percentage_fee`", type="float", nullable=true)
     */
    protected $percentage_fee;

    /**
     * @ORM\Column(name="`active_from_id`", type="integer", nullable=true)
     */
    protected $active_from_id;

    /**
     * @ORM\Column(name="`active_until_id`", type="integer", nullable=true)
     */
    protected $active_until_id;

    /**
     * @ORM\Column(name="`days2pay`", type="integer", nullable=true)
     */
    protected $days2pay;
    ...
    /**
     * @ORM\OneToMany(targetEntity="BankAccountCsv", mappedBy="paymentType")
     * @ORM\JoinColumn(name="`id`", referencedColumnName="`payment_type_id`")
     */
    protected $bankAccountCsvs;

    /**
     * @ORM\OneToMany(targetEntity="BankStatement", mappedBy="paymentType")
     * @ORM\JoinColumn(name="`id`", referencedColumnName="`payment_type_id`")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Currency", inversedBy="paymentTypes")
    ...
    {
        $dataFields = array('id', 'position', 'preselected', 'name', 'virtual', 'statement_format', 'logo', 'short_description', 'long_description', 'explanation', 'fix_fee', 'percentage_fee', 'active_from_id', 'active_until_id', 'days2pay', 'type', 'visible', 'settings', 'updated', 'created', 'currency_id');
        $relationFields = array('deadline', 'deadline', 'currency');
        $copiedFields = array();
    ...
    {
        return array('id', 'position', 'preselected', 'name', 'virtual', 'statement_format', 'logo', 'short_description', 'long_description', 'explanation', 'fix_fee', 'percentage_fee', 'active_from_id', 'active_until_id', 'days2pay', 'type', 'visible', 'settings', 'updated', 'created', 'currency_id');
    }
}