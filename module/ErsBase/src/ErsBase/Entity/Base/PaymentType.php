 ...
 * Version 2.1.6-dev (doctrine2-mappedsuperclass) on 2017-02-11 12:20:28.
...
abstract class PaymentType
{
    ...
    {
        $dataFields = array('id', 'position', 'name', 'virtual', 'statement_format', 'logo', 'short_description', 'long_description', 'explanation', 'fix_fee', 'percentage_fee', 'active_from_id', 'active_until_id', 'days2pay', 'type', 'visible', 'settings', 'updated', 'created');
    ...
    {
        return array('id', 'position', 'name', 'virtual', 'statement_format', 'logo', 'short_description', 'long_description', 'explanation', 'fix_fee', 'percentage_fee', 'active_from_id', 'active_until_id', 'days2pay', 'type', 'visible', 'settings', 'updated', 'created');
    }
}