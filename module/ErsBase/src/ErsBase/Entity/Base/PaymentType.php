...
abstract class PaymentType
{
    ...
    {
        $dataFields = array('id', 'position', 'name', 'virtual', 'statement_format', 'logo', 'short_description', 'long_description', 'explanation', 'fix_fee', 'percentage_fee', 'active_from_id', 'active_until_id', 'days2pay', 'type', 'visible', 'settings', 'updated', 'created', 'currency_id');
    ...
    {
        return array('id', 'position', 'name', 'virtual', 'statement_format', 'logo', 'short_description', 'long_description', 'explanation', 'fix_fee', 'percentage_fee', 'active_from_id', 'active_until_id', 'days2pay', 'type', 'visible', 'settings', 'updated', 'created', 'currency_id');
    }
}