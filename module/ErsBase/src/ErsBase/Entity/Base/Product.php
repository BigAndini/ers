...
class Product
{
    ...
    {
        $dataFields = array('id', 'tax_id', 'position', 'name', 'short_description', 'long_description', 'active', 'visible', 'deleted', 'personalized', 'updated', 'created');
    ...
    {
        return array('id', 'tax_id', 'position', 'name', 'short_description', 'long_description', 'active', 'visible', 'deleted', 'personalized', 'updated', 'created');
    }
}