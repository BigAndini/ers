...
abstract class Product
{
    ...
    /**
     * @ORM\Column(name="`calculated_as_subproduct`", type="boolean", nullable=true)
     */
    protected $calculated_as_subproduct;
     ...
     * @ORM\JoinColumn(name="`id`", referencedColumnName="`sub_product_id`")
     */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Counter", mappedBy="products")
     */
    protected $counters;
    ...
    /**
     * Set the value of calculated_as_subproduct.
     *
     * @param boolean $calculated_as_subproduct
     * @return \ErsBase\Entity\Base\Product
     */
    public function setCalculatedAsSubproduct($calculated_as_subproduct)
    {
        $this->calculated_as_subproduct = $calculated_as_subproduct;

        return $this;
    }

    /**
     * Get the value of calculated_as_subproduct.
     *
     * @return boolean
     */
    public function getCalculatedAsSubproduct()
    {
        return $this->calculated_as_subproduct;
    }
    ...
    /**
     * Add ProductPackage entity related by `sub_product_id` to collection (one to many).
     *
     * @param \ErsBase\Entity\Base\ProductPackage $productPackage
     * @return \ErsBase\Entity\Base\Product
     */
    ...
    /**
     * Remove ProductPackage entity related by `sub_product_id` from collection (one to many).
     *
     * @param \ErsBase\Entity\Base\ProductPackage $productPackage
     * @return \ErsBase\Entity\Base\Product
     */
    ...
    /**
     * Get ProductPackage entity related by `sub_product_id` collection (one to many).
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    ...
    {
        $dataFields = array('id', 'tax_id', 'position', 'display_name', 'name', 'short_description', 'long_description', 'disabled', 'active', 'visible', 'visible_on_eticket', 'deleted', 'personalized', 'calculated_as_subproduct', 'ticket_template', 'updated', 'created');
    ...
    {
        return array('id', 'tax_id', 'position', 'display_name', 'name', 'short_description', 'long_description', 'disabled', 'active', 'visible', 'visible_on_eticket', 'deleted', 'personalized', 'calculated_as_subproduct', 'ticket_template', 'updated', 'created');
    }
}