 ...
 * Version 2.1.6-dev (doctrine2-mappedsuperclass) on 2017-02-06 08:44:55.
...
abstract class BankAccount
{
    ...
    /**
     * @ORM\Column(name="`kto`", type="string", length=45, nullable=true)
     */
    protected $kto;

    /**
     * @ORM\Column(name="`blz`", type="string", length=45, nullable=true)
     */
    protected $blz;
    ...
    {
        $dataFields = array('id', 'name', 'bank', 'virtual', 'statement_format', 'type', 'settings', 'iban', 'bic', 'kto', 'blz', 'updated', 'created');
    ...
    {
        return array('id', 'name', 'bank', 'virtual', 'statement_format', 'type', 'settings', 'iban', 'bic', 'kto', 'blz', 'updated', 'created');
    }
}