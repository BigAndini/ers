...
abstract class ProductVariant
{
    ...
    /**
     * @ORM\Column(name="`statsname`", type="string", length=100, nullable=true)
     */
    protected $statsname;
    ...
    /**
     * @ORM\Column(name="`preselection`", type="text", nullable=true)
     */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Counter", inversedBy="productVariants")
     * @ORM\JoinTable(name="`counter_has_product_variant`",
    ...
    {
        $counter->addProductVariant($this);
    ...
    {
        $counter->removeProductVariant($this);
    ...
    {
        $dataFields = array('id', 'product_id', 'active', 'disabled', 'statsname', 'position', 'name', 'type', 'preselection', 'updated', 'created');
    ...
    {
        return array('id', 'product_id', 'active', 'disabled', 'statsname', 'position', 'name', 'type', 'preselection', 'updated', 'created');
    }
}