...
class Item
{
    ...
    {
        $dataFields = array('id', 'code_id', 'status_id', 'Product_id', 'Package_id', 'name', 'short_description', 'long_description', 'price', 'amount', 'info', 'personalized', 'agegroup', 'shipped', 'transferred_item_id', 'updated', 'created');
    ...
    {
        return array('id', 'code_id', 'status_id', 'Product_id', 'Package_id', 'name', 'short_description', 'long_description', 'price', 'amount', 'info', 'personalized', 'agegroup', 'shipped', 'transferred_item_id', 'updated', 'created');
    }
}