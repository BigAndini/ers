...
abstract class Item
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Currency", inversedBy="items")
    ...
    {
        $dataFields = array('id', 'code_id', 'status_id', 'Product_id', 'Package_id', 'name', 'short_description', 'long_description', 'price', 'currency_id', 'amount', 'info', 'personalized', 'agegroup', 'transferred_item_id', 'shipped', 'shipped_date', 'updated', 'created');
        $relationFields = array('product', 'package', 'item', 'status', 'code', 'currency');
        $copiedFields = array();
    ...
    {
        return array('id', 'code_id', 'status_id', 'Product_id', 'Package_id', 'name', 'short_description', 'long_description', 'price', 'currency_id', 'amount', 'info', 'personalized', 'agegroup', 'transferred_item_id', 'shipped', 'shipped_date', 'updated', 'created');
    }
}