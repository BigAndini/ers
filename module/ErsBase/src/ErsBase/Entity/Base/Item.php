...
class Item
{
    ...
    {
        $dataFields = array('id', 'code_id', 'Product_id', 'Package_id', 'name', 'shortDescription', 'longDescription', 'price', 'amount', 'info', 'status', 'personalized', 'agegroup', 'shipped', 'transferred_item_id', 'updated', 'created');
    ...
    {
        return array('id', 'code_id', 'Product_id', 'Package_id', 'name', 'shortDescription', 'longDescription', 'price', 'amount', 'info', 'status', 'personalized', 'agegroup', 'shipped', 'transferred_item_id', 'updated', 'created');
    }
}