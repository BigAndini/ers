 ...
 * @ORM\Table(name="`item`", indexes={@ORM\Index(name="fk_Item_Product1_idx", columns={"`Product_id`"}), @ORM\Index(name="fk_Item_Package1_idx", columns={"`Package_id`"}), @ORM\Index(name="fk_item_item1_idx", columns={"`transferred_item_id`"}), @ORM\Index(name="fk_item_status1_idx", columns={"`status_id`"}), @ORM\Index(name="fk_item_code1_idx", columns={"`code_id`"})})
...
abstract class Item
{
    ...
    /**
     * @ORM\Column(name="`agegroup`", type="datetime", nullable=true)
     */
    protected $agegroup;

    /**
     * @ORM\Column(name="`transferred_item_id`", type="integer", nullable=true)
     */
    ...
    /**
     * @ORM\OneToOne(targetEntity="Code", inversedBy="item", cascade={"persist", "merge"})
    ...
    {
        $dataFields = array('id', 'code_id', 'status_id', 'Product_id', 'Package_id', 'name', 'short_description', 'long_description', 'price', 'currency', 'amount', 'info', 'personalized', 'agegroup', 'transferred_item_id', 'shipped', 'shipped_date', 'updated', 'created');
        $relationFields = array('product', 'package', 'item', 'status', 'code');
        $copiedFields = array();
    ...
    {
        return array('id', 'code_id', 'status_id', 'Product_id', 'Package_id', 'name', 'short_description', 'long_description', 'price', 'currency', 'amount', 'info', 'personalized', 'agegroup', 'transferred_item_id', 'shipped', 'shipped_date', 'updated', 'created');
    }
}