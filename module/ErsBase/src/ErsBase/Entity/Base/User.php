...
class User
{
    ...
    {
        $dataFields = array('id', 'session_id', 'username', 'email', 'email_status', 'display_name', 'firstname', 'surname', 'Country_id', 'password', 'hashkey', 'state', 'active', 'birthday', 'updated', 'created');
    ...
    {
        return array('id', 'session_id', 'username', 'email', 'email_status', 'display_name', 'firstname', 'surname', 'Country_id', 'password', 'hashkey', 'state', 'active', 'birthday', 'updated', 'created');
    }
}