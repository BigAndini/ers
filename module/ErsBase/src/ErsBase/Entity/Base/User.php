 ...
 * Version 2.1.6-dev (doctrine2-mappedsuperclass) on 2017-07-19 21:47:54.
...
abstract class User
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Mailq", mappedBy="user")
     * @ORM\JoinColumn(name="`id`", referencedColumnName="`from_id`")
     */
    protected $mailqs;

    /**
     * @ORM\OneToMany(targetEntity="MailqHasUser", mappedBy="user")
     * @ORM\JoinColumn(name="`id`", referencedColumnName="`user_id`")
     */
    ...
    public function __construct()
    {
        ...
        $this->mailqs = new ArrayCollection();
    ...
    /**
     * Add Mailq entity to collection (one to many).
     *
     * @param \ErsBase\Entity\Base\Mailq $mailq
     * @return \ErsBase\Entity\Base\User
     */
    public function addMailq(Mailq $mailq)
    {
        $this->mailqs[] = $mailq;
    ...
    /**
     * Remove Mailq entity from collection (one to many).
     *
     * @param \ErsBase\Entity\Base\Mailq $mailq
     * @return \ErsBase\Entity\Base\User
     */
    public function removeMailq(Mailq $mailq)
    {
        $this->mailqs->removeElement($mailq);

        return $this;
    }

    /**
     * Get Mailq entity collection (one to many).
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getMailqs()
    {
        return $this->mailqs;
    }
