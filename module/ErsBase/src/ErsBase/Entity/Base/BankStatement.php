...
abstract class BankStatement
{
    ...
    /**
     * @ORM\Column(name="`bank_account_csv_id`", type="integer")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="PaymentType", inversedBy="bankStatements")
    ...
    {
        $dataFields = array('id', 'payment_type_id', 'bank_account_csv_id', 'hash', 'status', 'updated', 'created');
        $relationFields = array('bankAccountCsv', 'paymentType');
        $copiedFields = array();
    ...
    {
        return array('id', 'payment_type_id', 'bank_account_csv_id', 'hash', 'status', 'updated', 'created');
    }
}