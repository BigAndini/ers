...
abstract class ProductVariantValue
{
    ...
    {
        $dataFields = array('id', 'ProductVariant_id', 'position', 'value', 'active', 'disabled', 'visible', 'updated', 'created');
    ...
    {
        return array('id', 'ProductVariant_id', 'position', 'value', 'active', 'disabled', 'visible', 'updated', 'created');
    }
}