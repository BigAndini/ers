    ...
    public function getServiceConfig() {
        return array(
            'factories' => array(
                 ...
                 * MySQL Factories
                 */
                'Catalogue\Model\StickyNotesTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\StickyNotesTable($dbAdapter);
                    return $table;
                },
                'Catalogue\Model\UserTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\UserTable($dbAdapter);
                    return $table;
                },
                'Catalogue\Model\RoleTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\RoleTable($dbAdapter);
                    return $table;
                },
                'Catalogue\Model\ProductTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\ProductTable($dbAdapter);
                    return $table;
                },
                'Catalogue\Model\ProductVariantTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new Model\ProductVariantTable($dbAdapter);
                    return $table;
                },
                'Catalogue\Model\ProductVariantValueTable' => function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                 ...
                 * Form Factories
                 */
                'Catalogue\Form\ProductViewForm' => function($sm){
